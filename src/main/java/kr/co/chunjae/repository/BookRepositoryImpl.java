...
public class BookRepositoryImpl implements BookRepository {
    ...
    public Set<Book> getBookListByFilter(Map<String, List<String>> filter) {
        ...
        // 전체 도서 목록 중에서 publisher 필드 값과 일치하는 도서를 검색한다.
        ...
        // 전체 도서 목록 중에서 category 필드 값과 일치하는 도서를 검색한다.
        ...
        // booksByCategory 객체에 등록된 도서와 booksByPublisher에 등록된 도서 목록 중
        // 중복되는 도서만 남기고 나머지는 삭제
        booksByCategory.retainAll(booksByFilter);
        return booksByCategory;
    }
    ...
    public void setNewBook(Book book) {
        listOfBooks.add(book);  // 신규 도서 정보를 listOfBooks에 추가로 저장한다.
    }
}
